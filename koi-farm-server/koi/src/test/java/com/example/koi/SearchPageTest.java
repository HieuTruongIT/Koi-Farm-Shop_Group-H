...
import org.testng.annotations.AfterClass; // Import @AfterClass từ TestNG
...
public class SearchPageTest {
    ...
    public void testWeatherInformation() {
        ...
        WebElement temperature = driver
                .findElement(By.xpath("//div[@class='weather-info']/p[contains(text(), 'Nhiệt độ')]"));
